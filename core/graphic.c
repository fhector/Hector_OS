...
void init_palette(void)
{
	static unsigned char table_rgb[16 * 3] = {
		...
		0xff, 0x00, 0x00,	/*  1:luminous red  */
		0x00, 0xff, 0x00,	/*  2:luminous green */
		0xff, 0xff, 0x00,	/*  3:luminous yellow */
		0x00, 0x00, 0xff,	/*  4:bright blue*/
		0xff, 0x00, 0xff,	/*  5:luminous purple  */
...
{
	int i, eflags;
	eflags = io_load_eflags();					/* save flags */
	io_cli(); 									/* cli */
